...
export class AlterUserTableToAddCodeColumn1675033239060 implements MigrationInterface {
    name = 'AlterUserTableToAddCodeColumn1675033239060'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "users" ADD "code" character varying(6)`);
